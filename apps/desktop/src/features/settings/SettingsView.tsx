          ...
          <p className="text-sdr-text-muted mt-1">
            {scope === "connection"
              ...
              : scope === "preferences"
                ...
                : "Configure Huntronomer connectivity, swarm control, and platform preferences."}
          </p>
        </GlassHeader>
          ...
          <Section title="About">
            <div className="p-4 bg-sdr-bg-secondary rounded-lg border border-sdr-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium text-sdr-text-primary">Huntronomer</h3>
                  <p className="text-sm text-sdr-text-muted">
                    Autonomous threat hunting command deck
                  </p>
              ...
              <div className="mt-4 pt-4 border-t border-sdr-border text-sm text-sdr-text-muted">
                <p>
                  Coordinate autonomous hunt swarms, review live posture, and keep response lanes
                  operator directed.
                </p>
                <p className="mt-2">
                  <a
