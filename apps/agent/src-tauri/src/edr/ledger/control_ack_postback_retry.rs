//! Control-API acknowledgement postback retry ledger.
//!
//! Durable queue for Control API ACK postback calls that failed and need
...
use crate::api_server::{
    control_ack_retry_backoff_seconds, ControlResponseAckPostbackRoute,
    EDR_MAX_CONTROL_ACK_POSTBACK_RETRIES,
};

#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub(crate) struct EndpointControlAckPostbackRetry {
    pub(crate) retry_id: String,
    pub(crate) response_action_id: String,
    pub(crate) control_api_url: String,
    pub(crate) preferred_route: ControlResponseAckPostbackRoute,
    pub(crate) target_kind: String,
    pub(crate) target_id: String,
    pub(crate) ack_token: String,
    pub(crate) ack_token_hash: String,
...
pub(crate) struct EndpointControlAckPostbackRetryLedger {
    path: Option<PathBuf>,
...
impl EndpointControlAckPostbackRetryLedger {
    ...
    pub(crate) fn append(&mut self, retry: EndpointControlAckPostbackRetry) -> Result<()> {
        self.retries
...
pub(crate) fn read_control_ack_postback_retry_ledger(
    path: &FsPath,
