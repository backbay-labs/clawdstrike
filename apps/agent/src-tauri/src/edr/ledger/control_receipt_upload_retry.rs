//! Control-API receipt upload retry ledger.
//!
//! Durable queue for signed receipts pending upload to the control plane.
//! Entries are retried with exponential backoff until confirmed uploaded.
...
use crate::api_server::{
    control_ack_retry_backoff_seconds, ControlStoreReceiptRequest,
    EDR_MAX_CONTROL_RECEIPT_UPLOAD_RETRIES,
};

#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub(crate) struct EndpointControlReceiptUploadRetry {
    pub(crate) retry_id: String,
    pub(crate) control_api_url: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) receipt_id: Option<String>,
    pub(crate) receipt_hash: String,
    pub(crate) payload: ControlStoreReceiptRequest,
...
pub(crate) struct EndpointControlReceiptUploadRetryLedger {
    path: Option<PathBuf>,
...
impl EndpointControlReceiptUploadRetryLedger {
    ...
    pub(crate) fn append(&mut self, retry: EndpointControlReceiptUploadRetry) -> Result<()> {
        self.retries
...
pub(crate) fn read_control_receipt_upload_retry_ledger(
    path: &FsPath,
