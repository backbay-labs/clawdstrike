...
- [ ] **Phase 5: Spirit Reactivity & Editor Integration** — Mood reacts to hunt signals automatically; spirit kind shifts CodeMirror theme; observatory minimap in sidebar
