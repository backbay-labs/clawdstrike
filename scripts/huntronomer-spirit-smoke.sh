...
tests=(
  ...
  "src/shell/workbench/spirit-ritual/SpiritCreationChamber.test.tsx"
  "src/shell/workbench/spirit-ritual/IntentionSuggestions.test.tsx"
  "src/shell/workbench/spirit-ritual/state/draft.test.ts"
  "src/shell/workbench/spirit-ritual/draw/analysis.test.ts"
  "src/shell/workbench/spirit-ritual/upload/analysis.test.ts"
  "src/shell/workbench/spirit-ritual/modes/hybrid.test.ts"
  "src/shell/workbench/spirit-ritual/canvas/model.test.ts"
  "src/shell/workbench/spirit-ritual/atmosphere/SpiritAtmosphereLayer.test.tsx"
  "src/shell/workbench/spirit-ritual/release/SpiritReleaseChoreography.test.tsx"
