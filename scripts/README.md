...
14. `scripts/huntronomer-playwright-smoke.sh` - Huntronomer desktop shell smoke via Playwright CLI (`direct shell load -> Hunt Deck artifacts`), emitting `summary.json`.
