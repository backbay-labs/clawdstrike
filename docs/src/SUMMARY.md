...
- [Overview](fleet-security/index.md)
  - [Platform Framing](fleet-security/positioning.md)
  - [Current State](fleet-security/current-state.md)
  - [Target Architecture](fleet-security/architecture.md)
  - [Directory and Policy Plane](fleet-security/directory-and-policy.md)
  - [Directory Object Model Spec](fleet-security/directory-object-model.md)
  - [Effective Policy Resolution Spec](fleet-security/effective-policy-resolution.md)
  - [Principal Lifecycle Spec](fleet-security/principal-lifecycle.md)
  - [Directory API Contract Spec](fleet-security/directory-api-contract.md)
  - [Enrollment and Join Protocol Spec](fleet-security/enrollment-join-protocol.md)
  - [Grants and Delegation Graph Contract Spec](fleet-security/grants-delegation-graph.md)
  - [Directory Implementation Plan](fleet-security/directory-implementation.md)
  - [Directory Migration Plan](fleet-security/directory-migrations.md)
  - [Detection, Hunt, and Response](fleet-security/detection-response.md)
  - [Response Action Contract Spec](fleet-security/response-action-contract.md)
  - [Response Execution Pipeline Spec](fleet-security/response-execution-pipeline.md)
  - [Normalized Fleet Event Envelope Spec](fleet-security/normalized-fleet-event-envelope.md)
  - [Hunt Backend API and Data Model Spec](fleet-security/hunt-backend.md)
  - [Detection and Rule Model Spec](fleet-security/detection-rule-model.md)
  - [Suppression and Tuning Model Spec](fleet-security/suppression-tuning-model.md)
  - [Case and Evidence Bundle Model Spec](fleet-security/case-evidence-bundle-model.md)
  - [Rule Packaging and Distribution Model Spec](fleet-security/rule-packaging-distribution.md)
  - [Detection API Contract Spec](fleet-security/detection-api-contract.md)
  - [Detection Storage Model Spec](fleet-security/detection-storage-model.md)
  - [Fleet Console Read Model Spec](fleet-security/fleet-console-read-model.md)
  - [Code and Artifact Map](fleet-security/code-map.md)
  - [Delivery Roadmap](fleet-security/roadmap.md)
  - [Multi-Agent Execution Overview](fleet-security/execution-orchestration.md)
  - [Workstream Map](fleet-security/workstream-map.md)
  - [Dependency and Merge Graph](fleet-security/dependency-graph.md)
  - [Verification Matrix](fleet-security/verification-matrix.md)
  - [Codex CLI Orchestration Playbook](fleet-security/codex-cli-playbook.md)
  - [Agent Brief Pack](fleet-security/agent-briefs.md)
  - [Codex Swarm Pack](fleet-security/codex-swarm-pack.md)
