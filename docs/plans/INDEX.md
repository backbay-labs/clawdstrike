...
| [`god-file-decomposition/`](./god-file-decomposition/) | In flight (started 2026-06-01) | Behavior-preserving decomposition of the 8 largest source files into module trees, following the `api_server.rs` precedent (#355–#358). 8 steps tracked in INDEX; pure relocation, public API preserved, green build per commit. |
