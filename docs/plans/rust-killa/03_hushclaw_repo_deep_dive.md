...
- Dependencies: anyhow, chrono, clap, clap_complete, hex, hush-core, hushclaw, rand, reqwest, serde_json, sha2, tokio, tracing, tracing-subscriber
- Dev-dependencies: (none)
- Rust files: 0

### hushd (crates/hushd)
- Dependencies: anyhow, axum, chrono, clap, dirs, futures, hex, hush-core, hush-proxy, hushclaw, reqwest, rusqlite, serde, serde_json, serde_yaml, sha2, thiserror, tokio, tokio-stream, toml, tower, tower-http, tracing, tracing-subscriber, uuid
...
- `hushclaw`: guard framework + policy config + engine orchestration + receipt emission.
- `hush-cli`: a small CLI that calls into `hushclaw` and `hush-core`.
...
- Module doc: Canonical JSON for hashing/signatures (RFC 8785 JCS)  Hushclaw needs byte-for-byte identical canonical JSON across Rust/Python/TS. We adopt RFC 8785 (JCS) and match ECMAScript `JSO...
- pub fn: canonicalize
...
- Module doc: WebAssembly bindings for hush-core cryptographic primitives  This crate provides browser-side verification of hushclaw attestations.
...
- Module doc: Error types for hushclaw
- pub enum: Error
- pub type: Result
...
- Module doc: Security guards for AI agent execution.  Guards implement async checks that can allow, block, or log actions.  # Example  ```rust use hushclaw::guards::{ForbiddenPathGuard, GuardAc...
...
### crates/hushclaw/tests/proptest_guards.rs
...
- Evidence: `crates/hushclaw/src/policy.rs` has a `by_name` match that only supports `default|strict|permissive`.
...
- `hushclaw`: `ipnet` and `globset` appear unused.
...
- Pattern: `extends:`
  - docs/src/reference/rulesets/strict.md:20:extends: hushclaw:default
  - docs/src/reference/rulesets/strict.md:137:extends: hushclaw:strict
  - docs/src/reference/rulesets/strict.md:157:extends: hushclaw:strict
  - docs/src/reference/rulesets/README.md:27:extends: hushclaw:default
  ...
  - docs/src/reference/rulesets/ai-agent.md:20:extends: hushclaw:default
  - docs/src/reference/rulesets/ai-agent.md:188:extends: hushclaw:ai-agent
  - docs/src/reference/rulesets/ai-agent.md:208:extends: hushclaw:ai-agent
  - docs/src/reference/rulesets/default.md:144:extends: hushclaw:default
  - docs/src/reference/policy-schema.md:17:extends: hushclaw:default  # Optional base policy
  - docs/src/concepts/policies.md:11:extends: hushclaw:default     # Optional base policy
  - docs/src/concepts/policies.md:41:extends: hushclaw:ai-agent
  ...
  - docs/src/guides/policy-inheritance.md:19:extends: hushclaw:ai-agent
  ...
  - docs/src/guides/policy-inheritance.md:106:extends: hushclaw:strict
  ...
  - docs/src/guides/policy-inheritance.md:134:extends: hushclaw:default
  - docs/src/guides/policy-inheritance.md:145:extends: hushclaw:default
  - docs/src/guides/policy-inheritance.md:158:extends: hushclaw:default
  ...
  - docs/src/guides/policy-inheritance.md:223:extends: hushclaw:ai-agent  # Not from scratch
  - docs/src/guides/policy-inheritance.md:232:extends: hushclaw:ai-agent
  - docs/src/guides/policy-inheritance.md:256:extends: hushclaw:ai-agent
  - docs/src/guides/policy-inheritance.md:272:extends: hushclaw:strict
  - docs/src/guides/policy-inheritance.md:286:extends: file://./team-policy.yaml
  - docs/src/guides/openclaw-integration.md:190:extends: hushclaw:ai-agent
  - docs/src/recipes/github-actions.md:17:extends: hushclaw:cicd
  - docs/src/recipes/self-hosted.md:206:    extends: hushclaw:strict
  - docs/src/recipes/claude-code.md:27:extends: hushclaw:ai-agent
  - docs/src/recipes/claude-code.md:58:extends: hushclaw:ai-agent
  - docs/src/getting-started/quick-start.md:20:extends: hushclaw:ai-agent-minimal
  - docs/src/getting-started/first-policy.md:31:extends: hushclaw:ai-agent-minimal
  - docs/src/getting-started/first-policy.md:184:extends: hushclaw:ai-agent
  - docs/src/README.md:21:extends: hushclaw:ai-agent
...
- Pattern: `HUSHCLAW_MODE=`
  - docs/src/concepts/policies.md:133:HUSHCLAW_MODE=advisory hush run --policy policy.yaml -- command
  - docs/src/guides/openclaw-integration.md:149:HUSHCLAW_MODE=advisory openclaw start
  - docs/src/guides/openclaw-integration.md:233:HUSHCLAW_MODE=advisory openclaw start
...
- crates/hushclaw/src/engine.rs:311:            .unwrap();
- crates/hushclaw/src/engine.rs:318:            .unwrap();
- crates/hushclaw/src/engine.rs:331:            .unwrap();
- crates/hushclaw/src/engine.rs:338:            .unwrap();
- crates/hushclaw/src/engine.rs:351:            .unwrap();
- crates/hushclaw/src/engine.rs:367:            .unwrap();
- crates/hushclaw/src/engine.rs:370:        let receipt = engine.create_receipt(content_hash).await.unwrap();
- crates/hushclaw/src/engine.rs:384:            .unwrap();
- crates/hushclaw/src/engine.rs:387:        let signed = engine.create_signed_receipt(content_hash).await.unwrap();
- crates/hushclaw/src/engine.rs:394:        let engine = HushEngine::from_ruleset("strict").unwrap();
- crates/hushclaw/src/engine.rs:401:            .unwrap();
- crates/hushclaw/src/engine.rs:413:            .unwrap();
...
- crates/hushclaw/src/lib.rs:38://! let policy = Policy::from_yaml(yaml).unwrap();
...
- crates/hushclaw/src/policy.rs:293:        let yaml = policy.to_yaml().unwrap();
- crates/hushclaw/src/policy.rs:294:        let restored = Policy::from_yaml(&yaml).unwrap();
...
- crates/hushclaw/src/irm/sandbox.rs:255:        sandbox.init().await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:260:        sandbox.cleanup().await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:269:        sandbox.init().await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:275:            .unwrap();
- crates/hushclaw/src/irm/sandbox.rs:282:            .unwrap();
- crates/hushclaw/src/irm/sandbox.rs:290:        sandbox.init().await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:293:        let decision = sandbox.check_net("api.github.com", 443).await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:297:        let decision = sandbox.check_net("evil-site.com", 443).await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:305:        sandbox.init().await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:311:            .unwrap();
- crates/hushclaw/src/irm/sandbox.rs:321:            .unwrap();
- crates/hushclaw/src/irm/sandbox.rs:329:        sandbox.init().await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:334:            .unwrap();
- crates/hushclaw/src/irm/sandbox.rs:335:        sandbox.check_fs("/etc/shadow", false).await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:346:        sandbox.init().await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:351:            .unwrap();
- crates/hushclaw/src/irm/sandbox.rs:373:        sandbox.init().await.unwrap();
- crates/hushclaw/src/irm/sandbox.rs:387:        sandbox.init().await.unwrap();
...
- crates/hushclaw/src/irm/mod.rs:360:        let json = serde_json::to_string(&op).unwrap();
- crates/hushclaw/src/irm/mod.rs:371:        let json = serde_json::to_string(&op).unwrap();
- crates/hushclaw/src/irm/mod.rs:382:        let json = serde_json::to_string(&op).unwrap();
- crates/hushclaw/src/irm/mod.rs:521:        sandbox.init().await.unwrap();
- crates/hushclaw/src/irm/mod.rs:539:        sandbox.cleanup().await.unwrap();
- crates/hushclaw/src/irm/exec.rs:164:        let (cmd, args) = irm.extract_command_and_args(&call).unwrap();
- crates/hushclaw/src/irm/exec.rs:174:        let (cmd, args) = irm.extract_command_and_args(&call).unwrap();
